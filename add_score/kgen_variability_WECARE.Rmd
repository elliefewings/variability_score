...
file <- read.table("C:/data_local/WECARE/WECARE_2016feb/wecare_feb2016_std_filter_VV_biallelic.txt", sep = "\t", header = TRUE)
dim(file)
```
...
write.csv(clean, file= "WECARE_VV_variability_20160520.csv")
```
