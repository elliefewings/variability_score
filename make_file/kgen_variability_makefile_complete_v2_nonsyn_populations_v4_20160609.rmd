...
colnames(merge.scores.df)[(names(merge.scores.df) == "CHR")] <- "CHROM"
...
#write csv
write.csv(bind, file= "variability_thresholds_nonsyn_populations_complete_20160609.csv", quote=FALSE)
```