...
comb <- var %>% group_by(geneID) %>% mutate(COMBINED_SCORE = sum(VARIABILITY)/total_exons)
...
write.csv(complete, file="variability_thresholds_combinedscore_geneann_v3_nonsyn_20160601.csv", quote=FALSE)
